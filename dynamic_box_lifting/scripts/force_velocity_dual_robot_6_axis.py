...
from dynamic_box_lifting.utils.heal_controller_6_axis import HealController6Axis
from dynamic_box_lifting.utils.franka_controller_6_axis import FrankaController6Axis
...
def main():
    ...
    heal = HealController6Axis(
        # example override:
        # topic_ft="/ft_sensor",
        lambda_star=np.array([-7.0, 0, 0, 0, 0, 0], dtype=float)
    )
    franka = FrankaController6Axis(
        # example override:
